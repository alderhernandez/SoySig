                        ...
                        <?php 
                            if($this->session->userdata("logged") == 1){
                                echo '<li class="nav-item">
                                    <a class="p-1 nav-link btn btn-danger btn-xl text-uppercase" href="#">Bienvenido: '.$this->session->userdata("User").'</a>
                                    </li>';
                                echo '<li class="nav-item">
                                    <a class="p-1 nav-link btn  btn-sm text-uppercase" href="'.base_url('index.php/salir').'">Cerrar Sesión</a>
                                </li>';
                            }else{
                                echo '<li class="nav-item "><a class="p-1 nav-link btn btn-danger btn-xl text-uppercase" href="'.base_url('index.php/login').'">ACCEDER</a></li>';
                            }
                        ?>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Nos pondremos en contacto contigo.</h3>
                </div>
                <!-- * * * * * * * * * * * * * * *-->
